...
| `@AdebolaH` | Ibrahim Hassan | AdebolaH@users.noreply.github.com | Threat Hunting, Authorization Workflows |
| `@BlessingOUdoh-ui` | Blessing Udoh | BlessingOUdoh-ui@users.noreply.github.com | SOC Operations, Monitoring |
...
| 2025-11-21 | `675366f` | Initial Setup | Merge PR #1 from @2abet |
| 2025-11-06 | `17aa2a7` | Initial Setup | docs: 6-Tier Prompt Engineering |
| 2025-11-06 | `ec3e4eb` | Initial Setup | docs: Ollama local LLM support |
| 2025-11-06 | `d87e05b` | Initial Setup | feat: Ollama local LLM integration |
| 2025-11-02 | `451edc8` | Initial Setup | feat: Enhanced simulator |
...
| 2025-09-29 | `999bc07` | Initial Setup | refactor: Production deployment cleanup |
| 2025-09-28 | `228460a` | Initial Setup | refactor: Cleaner text output |
| 2025-09-28 | `e6ea4ec` | Initial Setup | feat: Content storage system |
| 2025-09-27 | `518d8da` | Initial Setup | docs: Virtual environment guide |
| 2025-09-27 | `fedabcc` | Initial Setup | feat: Template management system |
| 2025-09-26 | `74caf28` | Initial Setup | Initial commit: Ciicerone system |
...
2025-10-20          │  @2abet - Documentation fix (PR #1)
                    │
2025-11-06          │  Ollama integration (Foundation)
                    │
